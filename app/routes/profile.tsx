...
export default function Profile() {
  ...
  const calculateStats = () => {
    ...
    if (savedRewards) {
      ...
      const points = rewards.reduce((total: number, reward: any) => {
  ...
  return (
    <>
      <TopBar level={level} onSettingsClick={() => console.log('메뉴 버튼 클릭')} />
        ...
        <div className="container max-w-lg mx-auto space-y-6">
          ...
          <div className="card-default">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="card-default text-center">
                <div className="text-2xl font-bold text-accent mb-1">{totalPoints}</div>
                <div className="caption-text">누적 포인트</div>
              </div>
              <div className="card-default text-center">
                <div className="text-2xl font-bold text-secondary mb-1">{streak}일</div>
                <div className="caption-text">연속 달성</div>
              </div>
              <div className="card-default text-center">
                <div className="text-2xl font-bold text-success mb-1">{completionRate}%</div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                ...
                <button
                  ...
                  className={`relative w-12 h-6 rounded-full transition-colors duration-200 ${
                    darkMode ? 'bg-primary' : 'bg-bg-tertiary dark:bg-bg-tertiary-dark'
                  }`}
                >
                  <div
              ...
              <div className="flex items-center justify-between">
                ...
                <button
                  ...
                  className={`relative w-12 h-6 rounded-full transition-colors duration-200 ${
                    notifications ? 'bg-primary' : 'bg-bg-tertiary dark:bg-bg-tertiary-dark'
                  }`}
                >
                  <div
                    className={`absolute top-1 w-4 h-4 rounded-full bg-white transition-transform duration-200 ${
